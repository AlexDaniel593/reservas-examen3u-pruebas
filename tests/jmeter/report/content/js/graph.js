...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 1.0, "minX": 0.0, "maxY": 1.0, "series": [{"data": [[0.0, 1.0]], "isOverall": false, "label": "POST /api/reservas", "isController": false}, {"data": [[100.0, 1.0]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}, {"data": [[200.0, 1.0]], "isOverall": false, "label": "POST /api/auth/register", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 200.0, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.77012264E12, "maxY": 1.0, "series": [{"data": [[1.77012264E12, 1.0], [1.7701227E12, 1.0]], "isOverall": false, "label": "Usuarios", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.7701227E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 14.0, "minX": 1.0, "maxY": 295.0, "series": [{"data": [[1.0, 14.0]], "isOverall": false, "label": "POST /api/reservas", "isController": false}, {"data": [[1.0, 14.0]], "isOverall": false, "label": "POST /api/reservas-Aggregated", "isController": false}, {"data": [[1.0, 156.0]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}, {"data": [[1.0, 156.0]], "isOverall": false, "label": "POST /api/auth/login-Aggregated", "isController": false}, {"data": [[1.0, 295.0]], "isOverall": false, "label": "POST /api/auth/register", "isController": false}, {"data": [[1.0, 295.0]], "isOverall": false, "label": "POST /api/auth/register-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 1.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 4.4, "minX": 1.77012264E12, "maxY": 11.383333333333333, "series": [{"data": [[1.77012264E12, 11.383333333333333], [1.7701227E12, 4.4]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.77012264E12, 9.683333333333334], [1.7701227E12, 8.066666666666666]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.7701227E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 14.0, "minX": 1.77012264E12, "maxY": 295.0, "series": [{"data": [[1.7701227E12, 14.0]], "isOverall": false, "label": "POST /api/reservas", "isController": false}, {"data": [[1.77012264E12, 156.0]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}, {"data": [[1.77012264E12, 295.0]], "isOverall": false, "label": "POST /api/auth/register", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.7701227E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 14.0, "minX": 1.77012264E12, "maxY": 288.0, "series": [{"data": [[1.7701227E12, 14.0]], "isOverall": false, "label": "POST /api/reservas", "isController": false}, {"data": [[1.77012264E12, 156.0]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}, {"data": [[1.77012264E12, 288.0]], "isOverall": false, "label": "POST /api/auth/register", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.7701227E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.77012264E12, "maxY": 51.0, "series": [{"data": [[1.7701227E12, 0.0]], "isOverall": false, "label": "POST /api/reservas", "isController": false}, {"data": [[1.77012264E12, 0.0]], "isOverall": false, "label": "POST /api/auth/login", "isController": false}, {"data": [[1.77012264E12, 51.0]], "isOverall": false, "label": "POST /api/auth/register", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.7701227E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 156.0, "minX": 1.0, "maxY": 156.0, "series": [{"data": [[1.0, 156.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 1.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 156.0, "minX": 1.0, "maxY": 156.0, "series": [{"data": [[1.0, 156.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 1.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 0.016666666666666666, "minX": 1.77012264E12, "maxY": 0.016666666666666666, "series": [{"data": [[1.77012264E12, 0.016666666666666666]], "isOverall": false, "label": "POST /api/auth/register-success", "isController": false}, {"data": [[1.7701227E12, 0.016666666666666666]], "isOverall": false, "label": "POST /api/reservas-success", "isController": false}, {"data": [[1.77012264E12, 0.016666666666666666]], "isOverall": false, "label": "POST /api/auth/login-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.7701227E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
